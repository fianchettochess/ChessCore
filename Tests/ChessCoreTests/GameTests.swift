...
final class GameTests: XCTestCase {
    ...
    func testMoverColorAndClocksForBlackToMoveFENGame() {
        ...
        let clocksAfterBlack = game.clockTimes
        ...
        let clocksAfterWhite = game.clockTimes
